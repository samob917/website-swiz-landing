  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const result = await emailjs.sendForm(
        "service_x9kkaxn", // Your Gmail Service ID (you provided this)
        "template_pw6eygq", // Replace with your actual Template ID from EmailJS
        formRef.current,
        "gH4mRyjdPmvSERjtQ", // Replace with your Public Key from EmailJS
      )
      ...
      <section className="hero-background medical-pattern min-h-screen flex items-center justify-center">
        <div className="max-w-7xl mx-auto px-8 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            Ready to save hundreds of hours on residency scheduling? Let's discuss how we can transform your program.
          </p>
        </div>
      </section>
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    required
                    rows={6}
                    placeholder="Tell us about your residency program's scheduling challenges..."
                    disabled={isSubmitting}
                  />
                </div>
